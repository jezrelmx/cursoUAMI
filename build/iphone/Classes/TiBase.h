...
// in simulator we redefine to format for Hola_Ti Developer console
...
{\
	NSString * exceptionName = [@"org.hola_ti." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hola_ti";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIHola_TiNativeItemNone = -1, 
	UIHola_TiNativeItemSpinner = -2,
	UIHola_TiNativeItemProgressBar = -3,
	
	UIHola_TiNativeItemSlider = -4,
	UIHola_TiNativeItemSwitch = -5,
	UIHola_TiNativeItemMultiButton = -6,
	UIHola_TiNativeItemSegmented = -7,
	
	UIHola_TiNativeItemTextView = -8,
	UIHola_TiNativeItemTextField = -9,
	UIHola_TiNativeItemSearchBar = -10,
	
	UIHola_TiNativeItemPicker = -11,
	UIHola_TiNativeItemDatePicker = -12,
	
	UIHola_TiNativeItemInfoLight = -13,
	UIHola_TiNativeItemInfoDark = -14,
	
	UIHola_TiNativeItemDisclosure = -15,
	
	UIHola_TiNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Hola_Ti instances of
