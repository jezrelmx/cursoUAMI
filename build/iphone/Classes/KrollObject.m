...
//@interface Hola_TiObject : NSObject
//@end

@interface Hola_TiObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Hola_TiObject class]])
		{
			for (NSString *key in [[(Hola_TiObject*)o modules] allKeys])
			{
