...
/**
 The base class for all Hola_Ti modules
 */
...
/**
 Hola_Ti Platform calls this method on startup.
 */
-(void)startup;

/**
 Hola_Ti Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Hola_Ti Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Hola_Ti Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Hola_Ti Platform calls this method on resume.
 @param sender The sender of the event.
 */
